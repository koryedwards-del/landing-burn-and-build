...
const BODY_FIELD_META = {
  ...
  weight: {
    ...
    alert: 'Your weight is used to determine your LBM. LBM, predominantly muscle, is your metabolism. There are two metabolic numbers. Basal metabolic rate is minimum life requirements. Your muscle weight increases the BMR substantially so an accurate body weight will dramatically affect your Lean Body Mass measurement and your diet. A five pound error in LBM mass will be a one serving difference in daily protein servings. Just a reminder here. You\'re paying $149 for this program. The program will only be as beneficial as your answers are accurate.',
  },
  fatSource: {
