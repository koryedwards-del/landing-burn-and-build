...
export const KWARNER_WELCOME_COPY = {
  ...
  servings:
    'Page four is the servings page. Burn & Build turns everything from page three into daily servings divided across breakfast, lunch, dinner, and fruit so you have maximum strength and energy while losing fat as fast as this plan allows.',
  foodList:
...
export const KWARNER_MEAL_BUILD_STEPS = [
  ...
  'Step 1 Choose your protein from the protein & dairy list on page five. Find the serving size for that food. Add that exact amount to your plate.',
  'Step 2 Zero your scale again. Find the carbohydrate you want from the grain & starch food list on page five. Add that exact amount to your plate.',
  'Step 3 Veggies are optional. They are good for you but take up valuable space in your stomach. Remember this is an eating plan, not a not-eating plan. Zero your scale. Add the exact amount of veggies from page six to your plate (if desired).',
  ...
  'Do the same process for fruit on page six. Convenience tip: eat the same fruit for all three fruit servings. It\'s easier to clean three fruit servings at one time than three different fruits every day.',
  'For maximum results, do three things every day:',
  '1. Eat all the servings recommended. Eating less will cause muscle loss and slow fat burning.',
  '2. Alternate protein/carb meals with fruit.',
  '3. Eat every three hours or sooner. Set a timer to help you get in the groove.',
  'Most people quit in the first three days. By day four they\'re in the groove, and by day 7–10 they are feeling the changes.',
