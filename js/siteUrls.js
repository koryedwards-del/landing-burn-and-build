...
export const MENU_PLAN_WORKSHEET_URL = MENU_PLAN_WORKSHEET_DOWNLOAD_URL;

/** @deprecated Use SAMPLE_DIET_DOWNLOAD_URL */
export const SAMPLE_DIET_ATTACHMENT_URL = SAMPLE_DIET_DOWNLOAD_URL;
/** @deprecated Use MENU_PLAN_WORKSHEET_DOWNLOAD_URL */
export const BLANK_MENU_PLANS_DOWNLOAD_URL = MENU_PLAN_WORKSHEET_DOWNLOAD_URL;
/** @deprecated Use MENU_PLAN_WORKSHEET_URL */
export const BLANK_MENU_PLANS_URL = MENU_PLAN_WORKSHEET_URL;
/** @deprecated Use MENU_PLAN_WORKSHEET_DOWNLOAD_URL */
export const MENU_PLAN_TEMPLATE_DOWNLOAD_URL = MENU_PLAN_WORKSHEET_DOWNLOAD_URL;
/** @deprecated Use MENU_PLAN_WORKSHEET_URL */
export const MENU_PLAN_TEMPLATE_URL = MENU_PLAN_WORKSHEET_URL;
/** @deprecated Use MENU_PLAN_WORKSHEET_DOWNLOAD_URL */
export const MENU_PLAN_TEMPLATE_ATTACHMENT_URL = MENU_PLAN_WORKSHEET_DOWNLOAD_URL;
